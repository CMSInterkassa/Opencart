...
$_['text_ikgateway']           = '<a onclick="window.open(\'http://www.interkassa.com/\');"><img src="../image/payment/ikgateway.jpg" alt="Interkassa.com" title="Interkassa.com"/></a>';
...
$_['text_ik_urls']                = 'В разделе "Мои кассы -> Настройки кассы -> Интерфейс" необходимо везде включить "Разрешить переопределять в запросе "</b><br>';
...
$_['entry_pending_order_status']          = 'Статус заказа после задержаной оплаты:';
