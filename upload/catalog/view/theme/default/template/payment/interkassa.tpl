...
<?php if (!empty($payment_systems)) {
    include_once 'catalog/view/theme/default/template/payment/interkassa_pay_systems.tpl';
} ?>


<script type="text/javascript" src="/catalog/view/theme/default/javascript/interkassa.js"></script>
<script type="text/javascript">
  $("#ik_button").on('click', function () {
    $.post('index.php?route=payment/interkassa/confirm', 'flag=1', function (json) {
