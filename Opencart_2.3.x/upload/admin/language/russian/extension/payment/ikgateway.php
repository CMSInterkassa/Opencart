...
$_['text_ikgateway']           = '<a onclick="window.open(\'http://www.interkassa.com/\');"><img src="../image/extension/payment/ikgateway.jpg" alt="Interkassa.com" title="Interkassa.com"/></a>';
...
$_['entry_ik_currency_help']      = '11111Валюта, в которой магазин передает сумму платежа на платежный шлюз «Интеркасса». На 01.12.2013 Интеркасса принимает следующие валюты: RUB, UAH, EUR, USD.';
