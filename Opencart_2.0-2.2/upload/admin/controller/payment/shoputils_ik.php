...
class ControllerPaymentShoputilsIk extends Controller {
    ...
    public function index() {
        ...
        $data = $this->_setData(array(
            ...
            'clear_log'                 => $this->makeUrl('payment/shoputils_ik/clearLog'),
            'text_copyright'            => sprintf($this->language->get('text_copyright'), $this->language->get('heading_title')),
            'shoputils_ik_success_url'  => $server . 'index.php?route=payment/shoputils_ik/success',
            'shoputils_ik_fail_url'     => $server . 'index.php?route=payment/shoputils_ik/fail',
            'shoputils_ik_pending_url'  => $server . 'index.php?route=payment/shoputils_ik/success',
            'shoputils_ik_status_url'   => $server . 'index.php?route=payment/shoputils_ik/status',
        ...
        $this->response->setOutput($this->load->view('payment/shoputils_ik.tpl', $data));
    }
    ...
    protected function validatePermission() {
        return $this->user->hasPermission('modify', 'payment/shoputils_ik');
    }
